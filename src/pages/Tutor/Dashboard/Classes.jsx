...
import "./../../../style/Tutor/Classes.css";
    ...
    const fetchClasses = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${ipconfig}Classes/getClasses?tutorID=${user?.userID}`
            );
        ...
        <div className="classesPage">
            ...
            <div className="classesContainer">
                ...
                {classesList.length === 0 && !loading && (
                    <p className="emptyText">No Classes Found</p>
                )}
                ...
                {classesList.map((item) => (
                    ...
                    <div key={item.ClassID} className="classCard">
                        ...
                        <img
                            src={`${Image_URL}${item?.studentProfileImage}`}
                            className="avatar"
                            alt="student"
                        />
